...
.DESCRIPTION
    ...
    exist or is not 0x000fa000 (1024000) or greater, this is a finding.
    ...
    size (KB)" to "Enabled" with a "Maximum Log Size (KB)" of 1024000 or greater.
