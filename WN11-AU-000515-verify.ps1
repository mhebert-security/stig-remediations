...
<#
.SYNOPSIS
    Verifies the WN11-AU-000515 setting. Outputs PASS or FAIL.

.DESCRIPTION
    Checks the ACL on Application.evtx. Eventlog, SYSTEM, and Administrators must
    hold Full Control and no other principal may hold an allow rule.
